...
import com.plcoding.onboarding_presentation.nutrient_goal.viewmodel.NutrientGoalViewModel
    ...
    Box(
        ...
        Column(
            ...
            UnitTextField(
                ...
                onValueChange = {
                    viewModel.onEvent(NutrientGoalEvent.OnCarbRatioEventEnter(it))
                },
            ...
            UnitTextField(
                ...
                onValueChange = {
                    viewModel.onEvent(NutrientGoalEvent.OnProteinRatioEventEnter(it))
                },
            ...
            UnitTextField(
                ...
                onValueChange = {
                    viewModel.onEvent(NutrientGoalEvent.OnFatRatioEventEnter(it))
                },
