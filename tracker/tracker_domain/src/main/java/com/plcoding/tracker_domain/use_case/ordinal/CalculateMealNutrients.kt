...
class CalculateMealNutrients(
    ...
    // MealNutrientsは、APIコール後のデータを引数にとって格納していく簡易かな
    // これって引数はどっからとってくるんやろう → ローカルのデバイスに保存した奴から引っ張ってくるんや
    // このロジック美しすぎる
    operator fun invoke(trackedFoods: List<TrackedFood>): Result {
        ...
        val allNutrients = trackedFoods
            ...
            .mapValues { entry ->
                ...
                // どのくらい食べたかを保存した奴から全体でどのくらい食べたかの和をとってる
                MealNutrients(
        ...
        // 1日のカロリー摂取量
        val caloryGoal = dailyCalroryRequirement(userInfo)
        // それぞれ消費カロリーで割って接種すべきカロリーを表示してる
    ...
    // アクティブレベル、ゴールに応じてカロリー量を変化
    private fun dailyCalroryRequirement(userInfo: UserInfo): Int {
